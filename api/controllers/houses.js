...
router.post("/house/:id/rent/:rentID", passport.isAuthenticated(), (req, res) => {
  const { id } = req.params;
});

//modify a rent in the rentTable
router.put("/house/:id/rent/:rentID", passport.isAuthenticated(), (req, res) => {
  const { id } = req.params;
});

//delete a rent  in rentTable
router.delete("/house/:id/rent/:rentID", passport.isAuthenticated(), (req, res) => {
  const { id } = req.params;
});
